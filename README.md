# bazzite-dkub &nbsp; [![bluebuild build badge](https://github.com/dkolb/bazzite-dkub/actions/workflows/build.yml/badge.svg)](https://github.com/dkolb/bazzite-dkub/actions/workflows/build.yml)

A lightly customized image off of bazzite
...
```bash
cosign verify --key cosign.pub ghcr.io/dkolb/bazzite-dkub
```
